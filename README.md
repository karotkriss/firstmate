...
A presence-gated sub-supervisor (`/afk`) can self-handle routine events and batch only what matters while you step away, and ping you out of band with a native OS notification the moment a real decision needs you.
