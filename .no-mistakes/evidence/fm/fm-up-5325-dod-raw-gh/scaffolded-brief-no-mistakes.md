...
1. First action: create your branch: `git checkout -b fm/issue-5325-nm --`
...
4. Report status by appending one line:
   `echo "{state} [at=<epoch>]: {one short line}" >> '/home/cmckay/.no-mistakes/worktrees/80aee654c94f/01M39PSR7KCSAZR2W3XWKZQRD9/state/issue-5325-nm.status' && { [ ! -e '/home/cmckay/.no-mistakes/worktrees/80aee654c94f/01M39PSR7KCSAZR2W3XWKZQRD9/config/fleet-ledger' ] || '/home/cmckay/.no-mistakes/worktrees/80aee654c94f/01M39PSR7KCSAZR2W3XWKZQRD9/bin/fm-fleet-ledger.sh' appended '/home/cmckay/.no-mistakes/worktrees/80aee654c94f/01M39PSR7KCSAZR2W3XWKZQRD9/config' '/home/cmckay/.no-mistakes/worktrees/80aee654c94f/01M39PSR7KCSAZR2W3XWKZQRD9/state/issue-5325-nm.status' >/dev/null 2>&1 || true; }`
...
6. If a decision belongs above the implementation worker (product choices, destructive actions),
   ...
   For a no-mistakes ask-user gate specifically, escalate all ask-user findings as one event plus one snapshot file, using that same shape even when the gate holds only a single ask-user finding: write only the ask-user findings, verbatim and unparaphrased (id, severity, file, line, description, authority), to `/home/cmckay/.no-mistakes/worktrees/80aee654c94f/01M39PSR7KCSAZR2W3XWKZQRD9/data/issue-5325-nm/nm-<run>-findings.txt`, then report the gate with
   `needs-decision [at=<epoch>] [key=nm-<run>-<step>]: ask-user findings=<id1>,<id2>,... file=/home/cmckay/.no-mistakes/worktrees/80aee654c94f/01M39PSR7KCSAZR2W3XWKZQRD9/data/issue-5325-nm/nm-<run>-findings.txt`
...
Firstmate steers you through durable message files in '/home/cmckay/.no-mistakes/worktrees/80aee654c94f/01M39PSR7KCSAZR2W3XWKZQRD9/state/issue-5325-nm.inbox'.
When a terminal message says an instruction is waiting there - and at any natural checkpoint when you are unsure - list '/home/cmckay/.no-mistakes/worktrees/80aee654c94f/01M39PSR7KCSAZR2W3XWKZQRD9/state/issue-5325-nm.inbox'/*.msg, read and act on each message in numeric order, then acknowledge each handled message by moving it: `mv '/home/cmckay/.no-mistakes/worktrees/80aee654c94f/01M39PSR7KCSAZR2W3XWKZQRD9/state/issue-5325-nm.inbox'/NNN.msg '/home/cmckay/.no-mistakes/worktrees/80aee654c94f/01M39PSR7KCSAZR2W3XWKZQRD9/state/issue-5325-nm.inbox'/handled/`.
The move IS the acknowledgement: without it firstmate rings again and eventually treats you as stuck. An empty or absent inbox needs no action.

# Project memory
If `AGENTS.md` or `CLAUDE.md` already exists, or if this task produced durable project-intrinsic knowledge, run `/home/cmckay/.no-mistakes/worktrees/80aee654c94f/01M39PSR7KCSAZR2W3XWKZQRD9/bin/fm-ensure-agents-md.sh .` in the worktree.
Record only project knowledge useful to almost every future session.
For anything the codebase already shows, prefer a pointer to the authoritative file, command, or doc over copying the detail.
If you touch a project `AGENTS.md`, follow `/home/cmckay/.no-mistakes/worktrees/80aee654c94f/01M39PSR7KCSAZR2W3XWKZQRD9/bin/fm-ensure-agents-md.sh`'s self-governance contract in the same pass.
Keep it proportionate: skip `AGENTS.md` edits for trivial tasks that produced no durable project knowledge.

# Definition of done
Delivery contract: mode=no-mistakes
Ship branch: fm/issue-5325-nm
